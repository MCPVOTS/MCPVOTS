    ...
    # Use current gas policy (respect global overrides and defaults)
        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                self.logger.info(
                    (
                        "TICK | MAXX ${:.6f} | ETH ${:.2f} | ETH {:.6f} (avail {:.6f}) | "
                        "MAXX {:,.2f} | Entry ${:.6f} Peak ${:.6f} | entry_change {}{:.2f}% | since_last_{} {}{:.2f}% | {}{}"
                    ).format(
...
<parameter name="filePath">c:\PumpFun_Ecosystem\ECOSYSTEM_UNIFIED\master_trading_system_backup.py
